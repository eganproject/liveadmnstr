...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">Tambah Data Pendapatan Harian</h3>
        @if ($errors->any())
        ...
        <form action="{{ route('admin.dataharian.pendapatan-harian.store') }}" method="POST">
            @csrf
